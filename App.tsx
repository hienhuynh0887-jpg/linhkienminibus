...
export default function App(){
  ...
  return(
    <div style={{fontFamily:"'Segoe UI',system-ui,sans-serif",background:"#f0f4f8",minHeight:"100vh"}}>
      ...
      {/* HEADER */}
      <div style={{background:isTHCK?"linear-gradient(135deg,#0f2447,#1d4ed8)":"linear-gradient(135deg,#3b0a00,#b45309)",color:"#fff"}}>
        {/* Top bar */}
                              ...
                              {(ph.ct||[]).map((c,i)=>(
                                <tr key={c.id} style={{borderBottom:"1px solid #f1f5f9",background:c.sl>0?(i%2===0?"#f0fdf4":"#f7fef9"):(i%2===0?"#fff":"#fafafa")}}>
                                  ...
                                  <td style={{padding:"7px 10px"}}>
                                    {c.sl>0
                                      ?<span style={{background:"#d1fae5",color:"#065f46",borderRadius:10,padding:"2px 8px",fontSize:10,fontWeight:700}}>✓ Đã soạn</span>
                                      :<span style={{background:"#f1f5f9",color:"#9ca3af",borderRadius:10,padding:"2px 8px",fontSize:10}}>Chưa soạn</span>
                                    }
                                  </td>
                                </tr>
                              ))}
                            ...
                            {fil.map((v,ri)=>(
                              <Fragment key={v.ma}>
                                <tr style={{borderBottom:"1px solid #f1f5f9",background:v.done?"#f0fdf4":ri%2===0?"#fff":"#fafafa"}}>
                                  ...
                                  <td style={{padding:"7px 10px",textAlign:"center",fontWeight:700,color:v.done?"#16a34a":"#dc2626"}}>
                                    {v.done?"✅":v.chuaSoan
                                      ?<span style={{background:"#f1f5f9",color:"#6b7280",borderRadius:8,padding:"1px 6px",fontSize:10,fontWeight:700}}>📭 Chưa soạn</span>
                                      :<span><span style={{color:"#dc2626"}}>{fmt(v.ct)}</span><br/><span style={{fontSize:9,color:"#f59e0b",fontWeight:600}}>📉 Giao thiếu</span></span>
                                    }
                                  </td>
