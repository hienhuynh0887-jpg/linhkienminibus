...
const RE_HAS_VN_DIACRITIC=/[àáạảãâầấậẩẫăằắặẳẵèéẹẻẽêềếệểễìíịỉĩòóọỏõôồốộổỗơờớợởỡùúụủũưừứựửữỳýỵỷỹđÀÁẠẢÃÂẦẤẬẨẪĂẰẮẶẲẴÈÉẸẺẼÊỀẾỆỂỄÌÍỊỈĨÒÓỌỎÕÔỒỐỘỔỖƠỜỚỢỞỠÙÚỤỦŨƯỪỨỰỬỮỲÝỴỶỸĐ]/;
const I18N_SKIP_TAGS=new Set(["SCRIPT","STYLE","NOSCRIPT","TEXTAREA","INPUT"]);
const _i18nOrigText=new WeakMap();   // Text node → chữ gốc tiếng Việt
const _i18nOrigAttr=new WeakMap();   // Element → {placeholder,title,'aria-label': chữ gốc}
const I18N_ATTRS=["placeholder","title","aria-label"];
function _translateAttrs(el, toZh){
...
function _translateTextNode(tn, toZh){
...
function walkAndTranslateDOM(root, toZh){
  if(!root) return;
